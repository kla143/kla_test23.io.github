...
$query_rec_kla_mem = "SELECT * FROM std_it12";
$rec_kla_mem = mysql_query($query_rec_kla_mem, $mysqli) or die(mysql_error());
$row_rec_kla_mem = mysql_fetch_assoc($rec_kla_mem);
$totalRows_rec_kla_mem = mysql_num_rows($rec_kla_mem);
?>
<?php
